...
## Dropped (reason)
- Python count revised 164→165 (G6 guardrail adds test_subprocess_guard [14 new: bare bash-without-cwd, shell=True, os.system, explicit cwd=None, cwd= passes clean, `# subprocess-ok` suppression scoped to the marked call only, JSON output shape, CLI exit codes + --help hygiene]).
