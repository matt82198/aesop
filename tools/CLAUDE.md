...
- `status_publish.py` — Publish compact fleet-status snapshot to GitHub issue (phone-reachable, no local exposure); gathers agents/PRs/heartbeats/BUILDLOG/pending items; redacts secrets/paths/conductor3; idempotent (skips unchanged); CLI: `[--once] [--issue N] [--dry-run] [--comment]`; exit 0=success, 1=publish failed, 2=error
